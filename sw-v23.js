...
const precacheFiles = [
    ...
    "https://jibres.com/cdn/logo/icon/png/Jibres-Logo-icon-144.png",
    "https://jibres.com/cdn/logo/icon/svg/Jibres-Logo-icon.svg",
...
function networkFirstFetch(event) {
    event.respondWith(
        fetch(event.request)
            ...
            .catch(function (error) {
                console.log(
                    "Network request Failed. Serving content from cache: " +
                        error
                );
